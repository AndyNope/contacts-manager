            ...
            <div class="col-md-8 col-lg-6">
                <div class="auth-card">
                    ...
                    <form method="POST" action="/api/register.php" id="registerForm">
                        ...
                        <!-- Company Information -->
                        <div id="companyFields" class="mb-4">
                            <div class="row">
                                <div class="col-md-12 mb-3">
                                    <label for="company_name" class="form-label">Company Name <small class="text-muted">(Optional for Free Plan)</small></label>
                                    <input type="text" class="form-control" id="company_name" name="company_name" 
                                           value="<?= htmlspecialchars($_POST['company_name'] ?? '') ?>"
                                           placeholder="Leave empty for private profile">
                                    <small class="form-text text-muted">Free plan: Leave empty for a private profile like /private/profile/your-name</small>
                                </div>
                            </div>
                        </div>

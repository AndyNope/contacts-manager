        ...
        <div class="business-card">
            <div class="back-side">
                ...
                <div class="qr-section">
                    ...
                    <div style="font-size: 6px; color: #666; margin-top: 1mm;">Kontakt scannen</div>
                </div>
                
                <div class="company-info">
                    <div style="font-weight: bold; color: #dc2626; margin-bottom: 1mm;">24/7 NOTFALLDIENST</div>
                    <div>Winterthur & Bülach</div>
                    <div>+41 52 560 14 40</div>
                    <div>info@schuetz-schluesselservice.ch</div>
                    <div>www.schuetz-schluesselservice.ch</div>
                    
                    <div class="services">
                        <div>• Schlüsseldienst • Schreinerarbeiten •</div>
                        <div>• Sicherheitstechnik • Notöffnungen •</div>
                    </div>
                </div>
            </div>
        </div>
